...
function PlayChat()
{
  var flashMovie=getFlashMovieObject("chatFlash");
  flashMovie.Play();
}
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
  codebase="http://active.macromedia.com/flash2/cabs/swflash.cab#version=4,0,0,0"
  id="chatFlash" width=0 height=0> 
              <param name=movie value="./graphic/chat.swf"> 
              <param name=quality value=high> 
              <param name=play value=false> 
              <param name=bgcolor value=#FFFFFF> 
              <embed play=false swliveconnect="true" name="chatFlash"
                src="./graphic/chat.swf" quality=high bgcolor=#FFFFFF  
                width=0 height=0 type="application/x-shockwave-flash"  
                pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"> 
              </embed > 
 </object >
...
<?PHP
		echo '
			...
			<a onClick="'.popup_open(446, 558, "index.php?act=hint", "hint").'"> 
				...
				onMousemove="javascript: ShowPopup(event, this, \'Radio gorilla\');"
