...
$txt[23] = "Nome Utente non valido; il nome utente pu&ograve; contenere lettere ma non numeri, spazi, apostrofi, punti, virgolette e altri simboli. Il Nome Utente deve essere lungo meno di _n Caratteri.";		// _n is the number of charcters your username must be under
$txt[24] = "Inserite un indirizzo E-Mail valido.";
$txt[25] = "Inserite una Password.";
$txt[26] = "Le Password immesse non corrispondono.";
$txt[27] = "Spiacente, il Nome Utente che hai scelto &egrave; gi&agrave; in uso. Scegline un altro.";
$txt[28] = "Il tuo Accredito &egrave; stato creato, <a href=\"./index.php\">Clicca Qui</a> per entrare.";
...
$txt[70] = "Moderata";
$txt[71] = "Permanente";
$txt[72] = "Nome errato: il nome pu&ograve; contenere solo lettere e numeri, non simboli.";
$txt[73] = "Tipo di Stanza sconosciuto.";
$txt[74] = "Non potete creare Stanze private.";
$txt[75] = "La Stanza &egrave; stata creata.";
$txt[76] = "Questa Stanza &egrave; gi&agrave; in uso. Scegline un'altra.";
$txt[77] = "Indietro";
$txt[78] = "Richiesta Password";
$txt[79] = "Stanza protetta da Password. Inseriscila ora.";
$txt[80] = "Questa Stanza &egrave; piena, scegliene un'altra.";
...
$txt[101] = "L'utente &egrave; ora ignorato.";
$txt[102] = "L'utente non &egrave; pi&ugrave; ignorato.";
...
$txt[109] = "L'utente &egrave; stato espulso dalla Stanza, e non pu&ograve; rientrare per 60 secondi..";
$txt[110] = "_u &egrave; stato espulso per _r";	// _u will be replaced with username and _r will be replaced with reason

$txt[111] = "Questo utente &egrave; stato ridotto al Silenzio.";
$txt[112] = "Questo utente non &egrave; pi&ugrave; ridotto al Silenzio.";
$txt[113] = "Questo utente ha ora la Parola.";
$txt[114] = "A questo utente &egrave; stata tolta la Parola.";
...
$txt[127] = "_u Non &egrave; pi&ugrave; un Operatore della Stanza.";		// _u will print the username of the person who the action is preformed one.
...
$txt[130] = "_us non ha pi&ugrave; la Parola.";		// _u will print the username of the person who the action is preformed one.
$txt[131] = "_u &egrave; stato ridotto al silenzio.";		// _u will print the username of the person who the action is preformed one.
$txt[132] = "_u non &egrave; pi&ugrave; ridotto al silenzio.";		// _u will print the username of the person who the action is preformed one.
$txt[133] = "Chiudi";
$txt[134] = "Colore dei messaggi aggiornato.";
$txt[135] = "Pannello di Controllo dell'Utente";
$txt[136] = "Benvenuto nel Pannello di Controllo dell'Utente. Qui puoi cambiare i tuoi settaggi, inviare messaggi e configurare la Chat.";
...
$txt[158] = "_u &egrave; stato rimosso dalla lista ignorati.";	// _u is replaced with the person usersname
$txt[159] = "Ignora un utente";
$txt[160] = "Aggiungi";
$txt[161] = "_u &egrave; stato aggiunto alla tua lista ignorati.";	// _u is replaced with the person usersname
$txt[162] = "_w &egrave; stata filtrata.";		// _w is replaced with the word that was filtered
$txt[163] = "_w non &egrave; pi&ugrave; filtrata.";		// _w is replaced with the word that was unfiltered
...
$txt[182] = "Invia a";
$txt[183] = "Soggetto";
$txt[184] = "La casella di posta dell'utente &egrave; piena.";
...
$txt[195] = "Il caricamento dei Simboli &egrave; stato disabilitato.";
...
$txt[213] = "Il risultato &egrave;:";
$txt[214] = "Il risultato &egrave; stato modificato di _a.";	// _a is a number they are modified by
...
$txt[256] = "Ciao _u,\n\nA visitatore con indirizzo IP _i ha richiesto che la tua Password sia cambiata in _s Chat.\n\nLa tua nuova Password &egrave; _p.\n\nGrazie,\n_s Il Team di Supporto";			// Us "\n" for return/enter/new lines, _u for the username, _i for IP, _s for sitename, _p for new password
$txt[257] = "Immettere il vostro Nome Utente o indirizzo E-Mail per ricevere una nuova Password. La nuova Password verr&agrave; spedita all'indirizzo e-mail che abbiamo in memoria.";
$txt[258] = "La nuova Password &egrave; stata spedita";
$txt[259] = "La nuova Password non &egrave; stata spedita: Non siamo stati in grado di individuare un Accredito con questo Nome Utente o indirizzo di posta elettronica.";
$txt[260] = "Nuova Password non spedita: nel database non &egrave; presenta un indirizzo di posta elettronica corretto relativo a questo Accredito.";
$txt[261] = "L'Amministratore ha disabilitato la spedizione delle Parole d'Ordine.";
$txt[262] = "Novit&agrave;";
$txt[263] = "Spiacenti, non c'&egrave; un argomento d'aiuto per questo soggetto.";
...
$txt[277] = "<b>Sintassi:</b> /me <i>azione</i> <Br>Questo comando informer&agrave; gli altri utenti che voi state eseguendo la <i>azione</i>.";
...
$txt[279] = "_u &egrave; ora un amministratore di questa Stanza.";	// _u is the username
$txt[280] = "_u non &egrave; pi&ugrave; un amministratore di questa Stanza.";	// _u is the username
...
$txt[294] = "Il Messaggio del Giorno &egrave; vuoto.";	// (MOTD stands for Message Of The Day)
...
$txt[306] = "Questo &egrave; il pannello di controllo dell'Amministratore. Da qui potete configurare i settaggi, installare MODS, aggiornare i temi, e gestire molti altri aspetti della Stanza di Chat.";
$txt[307] = "Novit&agrave;";
$txt[308] = "Temi";
...
$txt[317] = "Faccine";
$txt[318] = "MODS";
$txt[319] = "L'XUpdater &egrave; disabilitato. Questo modulo &egrave; richiesto se volete utilizzare questa capacità. Potete abilitarla editando il file Config.php.";
$txt[320] = "Non ci sono novit&agrave;.";
...
$txt[340] = "Pu&ograve; essere settato a 0 per non abilitarlo.";
...
$txt[353] = "Scadenza in minuti dei messaggi";
...
$txt[385] = "Se non sai cos'&egrave;, non disabilitarla. Se il tuo sistema non la supporta, verr&agrave; disabilitata automaticamente.";
...
$txt[402] = "Il tema selezionato &egrave; stato installato.";
$txt[403] = "Rilasciato";
$txt[404] = "Autore";
$txt[405] = "Descrizione";
...
$txt[421] = "Il gruppo &egrave; stato cancellato.";
$txt[422] = "Pu&ograve; creare Stanze";
$txt[423] = "Pu&ograve; creare Stanze private";
$txt[424] = "Qui potete cambiare azioni che questo gruppo di utenti pu&ograve; compiere.";
$txt[425] = "Pu&ograve; settare le Stanze in modo che non si auto-cancellino.";
$txt[426] = "Pu&ograve; settare le Stanze in Moderate";
$txt[427] = "Pu&ograve; vedere l'indirizzo IP";
$txt[428] = "Pu&ograve; espellere gli utenti dalle Stanze";
$txt[429] = "Non pu&ograve; essere espulso o bandito";
$txt[430] = "Ha lo status di Operatore in tutte le Stanze";
$txt[431] = "Pu&ograve; spedire messaggi in tutte le Stanze";
$txt[432] = "Pu&ograve; vedere gli indirizzi E-Mail nascosti";
$txt[433] = "Pu&ograve; settare/cancellare le parole chiave";
$txt[434] = "Pu&ograve; controllare le registrazioni delle Stanze";
$txt[435] = "Pu&ograve; registrare i messaggi privati";
$txt[436] = "Pu&ograve; settare gli sfondi delle Stanze";
$txt[437] = "Pu&ograve; settare i loghi delle Stanze";
$txt[438] = "Pu&ograve; concedere i privilegi di Amministratore";
$txt[439] = "Pu&ograve; spedire messaggi Server";
$txt[440] = "Pu&ograve; usare il comando /mdeop";
$txt[441] = "Pu&ograve; usare il comando /mkick";
...
$txt[454] = "Puo' accedere alle Stanze di Chat quando disabilitate";
...
$txt[462] = "L'Accredito utente richiesto &egrave; stato rimosso.";
$txt[463] = "Accredito utente non trovato.";
$txt[464] = "L'Accredito utente &egrave; stato aggiornato.";
$txt[465] = "Sei sicuro di voler cancellare questa Stanza?";
$txt[466] = "La Stanza richiesta &egrave; stata cancellata.";
$txt[467] = "Questa Stanza &egrave; stata cancellata.";
...
$txt[475] = "Usato";
$txt[476] = "Massimo (MB)";
$txt[477] = "I valori per la banda utilizzata vengono misurati solo nelle pagine 'in Chat' e non includono l'intestazione di trasmissione. La banda per le altre pagine non &egrave; conteggiata.";
$txt[478] = "Puo' essere settato a 0 per illimitato o a -1 come predefinito.";
...
$txt[484] = "La registrazione &egrave; attualmente disabilitata, <a>Clicca Qui</a> per abilitarla.";	// Leave <a> and </a> alone
$txt[485] = "La registrazione &egrave; attualmente abilitata, <a>Clicca qui</a> per disabilitarla.";	// Leave <a> and </a> alone
...
$txt[494] = "L' E-Mail e' stata spedita a tutti i tuoi utenti registrati.";
...
$txt[501] = "Faccine";
$txt[502] = "Visita il sito <a href=\"http://x7chat.com/support.php\" target=\"_blank\">pagina di supporto</a> Per vedere la documentazione di amministrazione della Chat X7, e avere supporto tecnico.<Br><br>La documentazione per gli utenti &egrave; inclusa con la Chat X7 ed &egrave; disponibile <a href=\"./help/\" target=\"_blank\">qui</a>.";		// This one doesn't necessarily need to be translated
...
$txt[509] = "Non sei pi&ugrave; invisibile in questa Stanza";
$txt[510] = "Entra in tutte le Stanze in modalit&agrave; invisibile";
...
$txt[512] = "<span style=\"color: red; \">_u &egrave; stato bandito. Motivo: _r.</span><br>";	// _u is replaced with the username, _r is the reason
$txt[513] = "_u &egrave; stato riammesso in questa Stanza.";
...
$txt[558] = "Il vostro Tema &egrave; stato aggiornato.";
...
$txt[591] = "Modalita' Multi-Stanza";
$txt[592] = "Stanza Singola";
$txt[593] = "Se dovessi settare la Chat nella modalit&agrave; Stanza Singola, gli utenti saranno obbligati ad entrare nell'unica Stanza disponibile e, una volta entrati, non potranno, conseguentemente, selezionarne altre.";
$txt[594] = "Questa Stanza sta venendo utilizzata in modalit&agrave; Stanza Singola, non potete cancellarla. Disabilitate la modalit&agrave; Stanza Singola nella sezione Settaggi Generali del men&ugrave; Settaggi.";
$txt[595] = "* Nuova sessione di Supporto Clienti *";
$txt[596] = "Attendi .., qualcuno verra' presto da te.";
...
$txt[600] = "Il nuovo Accredito utente e' stato creato.";
...
$txt[606] = "Messaggio da visualizzare quando il supporto non e' disponibile";
...
/* Added in 2.0.1 */
$txt[613] = "Questa Stanza della Chat richiede l'attivazione per email prima che tu possa usare il tuo Accredito. Ti arrivera' una mail con le istruzioni su come attivarlo  nella casella di posta elettronica con cui ti sei registrato.";
$txt[614] = "Grazie il tuo Accredito e' stato attivato.";
$txt[615] = "Non e' possibile attivare il tuo Accredito, perche' il codice di attivazione che hai inserito e' sconosciuto.";
$txt[616] = "E' richiesta l'attivazione dell'Accredito";
$txt[617] = "Per attivare il tuo Accredito per la Stanza della Chat e' sufficiente visitare l'indirizzo riportato nella presente email: ";
$txt[618] = "Il tuo Accredito per la Stanza della Chat e' stato attivato";

/** Special strings **/

// Days of the week and months, these are simply easier and more efficient to do this way
$txt['Sunday'] = "Domenica";
$txt['Monday'] = "Luned&igrave;";
